...
if ( ! function_exists( 'woocommerce_single_variation_add_to_cart_button' ) ) {
	...
	function woocommerce_single_variation_add_to_cart_button() {
		...
		<button type="submit" class="single_add_to_cart_button button alt btn btn-default"><span><i class="entypo-plus"></i></span><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
